$(document).ready(function () {
    ...
    $(document).ready(function () {
        ...
        $(document).on("change keyup", ".step1 .input", function () {
            ...
            for (var i = 0; i < $(".completeDataTeacher .dataTeacher .step1 .input").length; i++) {
                ...
                if (i == $(".completeDataTeacher .dataTeacher .step1 .input").length - 1) {
                    ...
                    if (x != 0) {
                        $($(".completeDataTeacher .dataTeacher .step1").find(".submit")).attr("disabled", "disabled");
                    } else {
        ...
        $(document).on("change", ".completeDataTeacher .step4 input[name='exp']", function () {

            if ($($(".completeDataTeacher .step4 input[name='exp']")).is(':checked')) {
                check1Step4 = 1;
            } else {
                check1Step4 = 0;
            }
