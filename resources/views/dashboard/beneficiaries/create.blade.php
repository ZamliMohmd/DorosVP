        ...
        <section class="content">
                ...
                <div class="box box-primary">
                  ...
                  @include('dashboards.partials._errors')
                    <form action="{{ route('dashboard.beneficiaries.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <label for="exampleInputtext1">@lang('site.title')</label>
                              ...
                              <div class="form-group">
                                                <label for="exampleInputtext1">الوصف</label>
                                                    <textarea id="editor1" class="form-control" name="descriptionAr" rows="8">{!! old('descriptionAr') !!}</textarea>
                                            </div>
                        <div class="form-group">
                    ...
                    <!-- /.box-body -->
                          ...
                          <div class="tab-pane " id="tab_2">
                                ...
                                <label for="exampleInputtext1">العنوان باللغه الانجليزيه</label>
                                    <input type="text" class="form-control" name="titleEn" placeholder="@lang('site.title')"  value="{{ old('titleEn') }}">
                            </div>
                                        <div class="form-group">
                                                <label for="exampleInputtext1">description</label>
                                                    <textarea id="editor1" class="form-control" name="description_en" rows="8">{{ old('description_en') }}</textarea>
                                            </div>
