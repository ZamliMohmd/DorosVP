...
@section('content')
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">التخصصات الرئيسية</h3>
    ...
    border-color: #e08e0b;">
                                        <h4 class="modal-title" id="exampleModalLabel" style="font-weight: bold">اضافة تخصص رئيسي:</h4>
    ...
    border-radius: 5px;">
                        ...
                        <h3 align="center">مجموع التخصصات الرئيسية:<span id="total_records"></span></h3>
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach ($specialties as $key =>$specialty)
                                    <tr style="font-weight: bold">
                                        ...
                                        <td><a href="{{url('/admin/subspecialties/'.$specialty->id.'/index')}}"><button class="btn btn-info">اضغط هنا</button> </a></td>
