    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('dashboard.categoryReports.index') }}"><i class="fa fa-dashboard"></i> @lang('site.categories')</a></li>
        ...
        <section class="content">
                ...
                <div class="box box-primary">
                  <div class="box-header with-border">
                    <h3 class="box-title">اضافه تصنيفات التقارير</h3>
                  </div>
                  <!-- /.box-header -->
                  <!-- form start -->
                  @include('dashboards.partials._errors')
                  <form action="{{ route('dashboard.categoryReports.store') }}" method="POST" >
                    @csrf
                    <div class="box-body">
