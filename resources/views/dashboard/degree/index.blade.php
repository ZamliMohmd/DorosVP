...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">درجات علمية</li>
            </ol>
        </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                  <div class="box-header">
                    <h3 class="box-title">درجات علمية</h3>
    ...
    border-color: #e08e0b;">
                                      <h4 class="modal-title" id="exampleModalLabel" style="font-weight: bold">اضافة درجة علمية:</h4>
                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                          <span aria-hidden="true">&times;</span>
                                      </button>
                                  </div>
                                  <div class="modal-body">
                                      <form action="{{url('/admin/degree/new')}}" method="POST" style="display: inline-block;">
                                          @csrf
                                          @method('POST')
    ...
    border-radius: 5px;">
                      ...
                      <h3 align="center">مجموع الدرجات العلمية:<span id="total_records"></span></h3>
                                ...
                                <tbody>
                                  ...
                                  <th>التحكم</th>
                                   ...
                                   <tr style="font-weight: bold">
                                       ...
                                       <td>
                                           <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#cityModal{{$degre->id }}" data-whatever="@getbootstrap"><i class="fa fa-edit"></i>تعديل</button>

                                           <form action="{{url('/admin/universities/delete')}}" method="DELETE" style="display: inline-block;">
                                                        @csrf
                                                        @method('post')
                                               {{ csrf_field() }}
                                                        <input type="hidden" name="id" value="{{$degre->id }}">
                                   ...
                                   <div class="modal fade" id="cityModal{{$degre->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                       <div class="modal-dialog" role="document">
                                           <div class="modal-content">
                                               <div class="modal-header" style="background-color: #f39c12;
    border-color: #e08e0b;">
                                                   <h4 class="modal-title" id="exampleModalLabel" style="font-weight: bold">تعديل منطقة: {{$degre->name_ar }}</h4>
                                                   <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                       <span aria-hidden="true">&times;</span>
                                                   </button>
                                               </div>
                                               <div class="modal-body">
                                                   <form action="{{url('/admin/degree/update')}}" method="POST" style="display: inline-block;">
                                                       @csrf
                                                       @method('POST')
                                                       <input type="hidden" name="id" value="{{$degre->id }}">
                                                       <div class="form-group">
                                                           <label for="recipient-name" class="col-form-label">الاسم بالعربية</label>
                                                           <input name="name_ar" type="text" class="form-control" id="recipient-name"  value="{{$degre->name_ar}}">
                                                       </div>
                                                       <div class="form-group">
                                                           <label for="message-text" class="col-form-label">الاسم بالعبرية</label>
                                                           <input type="text" name="name_he" class="form-control" id="recipient-name" value="{{$degre->name_he}}" >
                                                       </div>
                                                       <button type="submit" class="btn btn-warning">حفظ</button>
                                                   </form>
                                               </div>
