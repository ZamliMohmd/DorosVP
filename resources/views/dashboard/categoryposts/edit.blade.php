    ...
    <div class="content-wrapper">
        ...
        <section class="content">
                ...
                <div class="box box-primary">
                  ...
                  <form action="{{ route('dashboard.categoryposts.update', $categorypost->id) }}" method="POST" >
                    @csrf
                    {{ method_field('put') }}
                    <div class="box-body">
                        <div class="form-group">
                            <label for="exampleInputtext1">@lang('site.name_category')</label>
                                <input type="text" class="form-control" name="nameAr" value="{{ $categorypost->nameAr }}">
                        </div>
                        <div class="form-group">
                                <label for="exampleInputtext1">@lang('site.name_category')</label>
                                    <input type="text" class="form-control" name="nameEn" value="{{ $categorypost->nameEn }}">
                            </div>
