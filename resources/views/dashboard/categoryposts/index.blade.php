            ...
            <div class="col-xs-12">
                <div class="box">
                  <div class="box-header">
                    ...
                    <a href="{{ route('dashboard.categoryposts.create') }}" class="btn btn-primary">
                                ...
                                @foreach ($categoryposts as $item)
                                   <tr>
                                    ...
                                    <td>
                                                ...
                                                <a href="{{ route('dashboard.categoryposts.edit', $item->id) }}" class="btn btn-primary">
                                                        <i class="fa fa-edit"></i> @lang('site.edit')
                                                      </a>
                                                    <form action="{{ route('dashboard.categoryposts.destroy', $item->id) }}" method="post" style="display: inline-block;">
                                                        @csrf
                                                        @method('DELETE')
